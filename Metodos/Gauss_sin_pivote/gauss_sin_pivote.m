...
% Last Modified by GUIDE v2.5 27-Sep-2018 14:49:34
...
matriz=A(:, 1:V);
vectorb=A(:,W);
set(handles.edit_vectorb, 'string', num2str(vectorb));
set(handles.edit_sistema, 'string', num2str(matriz));
set(handles.edit_SistemaC, 'string', num2str(A));
%set(handles.edit_sistema, 'string', num2str(A));

B = load('solucion.txt');
set(handles.edit_vectorX, 'string', num2str(B));
matTot=[A,B];
...
function edit_SistemaC_Callback(hObject, eventdata, handles)
% hObject    handle to edit_SistemaC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_SistemaC as text
%        str2double(get(hObject,'String')) returns contents of edit_SistemaC as a double


% --- Executes during object creation, after setting all properties.
function edit_SistemaC_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_SistemaC (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
